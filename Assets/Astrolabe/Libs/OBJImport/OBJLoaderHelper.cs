...
namespace Assets.Astrolabe.Libs.OBJImport
{
	public static class OBJLoaderHelper
	{
		...
		public static Material CreateDefaultMaterial(global::Astrolabe.Twinkle.ShaderMode shaderMode, string name = null)
		{
			...
			var material = TwinkleMaterialFactory.Clone(shaderMode);
