	...
	public static class DDSLoader
	{
		...
		public static Texture2D Load(byte[] ddsBytes)
		{
			try
			{
				...
				{
					throw new Exception(
						"Invalid DDS header. Structure length is incrrrect."); //this header byte should be 124 for DDS image files
				}
				...
				{
					throw new Exception(
						"Cannot load DDS due to an unsupported pixel format. Needs to be DXT1 or DXT5.");
				}
